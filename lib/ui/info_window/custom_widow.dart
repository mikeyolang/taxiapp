import 'package:taxiapp/models/citycab_info_window.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('${(info.time!.inMinutes) % 60}',
                                style: Theme.of(context).textTheme.titleMedium?.copyWith(color: CityTheme.cityWhite)),
                            Text('min',
                                style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: CityTheme.cityWhite)),
                          ],
                        ),
                      ),
                    Expanded(
                        child: Text(
                      '${info.name}',
                      style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: CityTheme.cityBlack),
                    ).paddingAll(8)),
